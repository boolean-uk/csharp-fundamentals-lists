...
namespace csharp_fundamentals_lists.Main
{
    public class Core
    {
        ...
        public List<string> Question3()
        {
            ...
            // remove exception and write code here
            //Wrote the code above instead because I cannot write more after return.
        }
        public List<string> Question4()
        {
            ...
            // remove exception and write code here
            results = _iceCreams.Concat(this.MoreIceCream).ToList().Concat(this.EvenMoreIceCream).ToList().Distinct().ToList();
            return results;
        }
