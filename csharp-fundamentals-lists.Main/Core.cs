...
namespace csharp_fundamentals_lists.Main
{
    public class Core
    {
        ...
        public List<string> Question3()
        {
            ...
            List<string> result = _iceCreams.Concat(this.MoreIceCream).Concat(EvenMoreIceCream).ToList();
            return result;
        ...
        public List<string> Question4()
        {
            ...
            List<string> results = _iceCreams.Concat(this.MoreIceCream).ToList();
            List<string> result = _iceCreams.Concat(this.MoreIceCream).Concat(EvenMoreIceCream).Distinct().ToList();
            // remove exception and write code here
            return result;
        }
